...
// Misc Guides
const ticketGuide = new lgReview(
  `Green Bay Packers Ticket Guide`,
  "../img/locals-guide/misc/packers-tickets.jpg",
  `Green Bay Packers tickets`,
  "../locals-guide/green-bay-packers-ticket-guide.html",
  null
);

const hotelGuide = new lgReview(
  `Green Bay Hotel Guide`,
  "../img/locals-guide/misc/green-bay-hotel.jpg",
  `Lodge Kohler hotel`,
  "../locals-guide/green-bay-hotel-guide.html",
  null
);

const parkingGuide = new lgReview(
  `Lambeau Field Parking Guide`,
  "../img/locals-guide/misc/lambeau-field-parking.jpg",
  `Lambeau Field Parking Lot`,
  "../locals-guide/lambeau-field-parking-guide.html",
  null
);

const tailgatingGuide = new lgReview(
  `Lambeau Field Tailgating Guide`,
  "../img/locals-guide/misc/lambeau-field-tailgating.jpg",
  `Grill with hot coals`,
  "../locals-guide/lambeau-field-tailgating-guide.html",
  null
);
...
const blackHoney = new lgReview(
  `Black Honey Hashery`,
  "../img/locals-guide/eat/breakfast/black-honey-hashery.jpg",
  `Black Honey Hashery's biscuits and gravy`,
  "../locals-guide/bay-family-restaurant.html",
  4.75
);

const thePancakePlace = new lgReview(
  `The Pancake Place`,
  "../img/locals-guide/eat/breakfast/the-pancake-place.jpg",
  `The Pancake Place stuffed hashbrowns`,
  "../locals-guide/the-pancake-place.html",
  4.6
);
...
const angelina = new lgReview(
  `Angelina`,
  "../img/locals-guide/eat/lunch/angelina.jpg",
  `Angelina ravioli`,
  "../locals-guide/angelina.html",
  4.75
);

const sarasArtisanGelato = new lgReview(
  `Sara's Artisan Gelato`,
  "../img/locals-guide/eat/dessert/saras-artisan-gelato.jpg",
  `Sara's Artisan Gelato over a brownie`,
  "../locals-guide/saras-artisan-gelato.html",
  4.75
);
