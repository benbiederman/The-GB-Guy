...
// Podcast Data
class Podcast {
    constructor(name, img, imgDesc, src, episode, seachTerms) {
        this.name = name;
        this.img = img;
...
function createContentItem(content){
    ...
    const contentEpisode = document.createElement('p');
    contentEpisode.textContent = `${content.episode}`;
    contentItem.appendChild(contentEpisode);
